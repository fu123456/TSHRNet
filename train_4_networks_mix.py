...
def train_model(UNet1, UNet2, UNet3, UNet4, dataloader, load_num_epoch, num_epoch, lr, dataset_name, parser, save_model_name='model'):
    ...
    for epoch in range(1, num_epoch+1):
        ...
        for input_img, gt_specular_residue, gt_diffuse, gt_diffuse_tc in tqdm(dataloader):
            ...
            estimated_diffuse = UNet1(input_img)
            estimated_specular_residue = UNet2(input_img)

            # estimation in the second stage
            G3_input = torch.cat([estimated_diffuse, input_img], dim=1)
            ...
            L_diffuse = loss_criterion(estimated_diffuse, gt_diffuse)
            ...
            # total loss
            L_total = L_diffuse + L_specular_residue + L_diffuse_refined + L_diffuse_tc
